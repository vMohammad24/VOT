...
import { ApplicationCommandOptionType, AutoModerationActionType, AutoModerationRuleEventType, AutoModerationRuleKeywordPresetType, AutoModerationRuleTriggerType, Role } from "discord.js";
import type ICommand from "../../handler/interfaces/ICommand";

const profanity: string[] = ((await axios.get("https://raw.githubusercontent.com/censor-text/profanity-list/main/list/en.txt")).data as string).split("\n").slice(0, 1000);
