...
export default {
	...
	execute: async () => {
		...
		if (res.data.success === true) {
			const { watchdog_lastMinute, watchdog_total, watchdog_rollingDaily, staff_rollingDaily, staff_total } =
				res.data.record;
           ...
           Staff Daily: ${staff_rollingDaily}\nStaff Total: ${staff_total}
				...
				.setThumbnail('https://cdn.nest.rip/uploads/99c9a424-071a-4199-b01d-af62b55dfa6b.png');
			return { embeds: [embed] };
		} else {
