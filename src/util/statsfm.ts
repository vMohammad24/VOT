...
export async function getUserTopArtists(
	...
	const response = await axiosInstance.get(
		`/${userId}/top/artists?range=weeks`,
	);
	return response.data;
}
...
export async function getUserCurrentStream(
	userId: string,
): Promise<CurrentStreamResponse> {
...
export async function getUserRecentStreams(
	userId: string,
...
export async function getUserStreamTrackStatsPerDay(
	userId: string,
	trackId: string,
) {
	return await axiosInstance.get(
		`/${userId}/streams/tracks/${trackId}/stats/per-day`,
	);
}

export async function getUserStreamTrackStatsDates(
	userId: string,
	trackId: string,
) {
	return await axiosInstance.get(
		`/${userId}/streams/tracks/${trackId}/stats/dates`,
	);
}
...
export async function getUserStreamArtistStats(
	userId: string,
	artistId: string,
) {
	return await axiosInstance.get(
		`/${userId}/streams/artists/${artistId}/stats`,
	);
}

export async function getUserStreamArtistStatsPerDay(
	userId: string,
	artistId: string,
) {
	return await axiosInstance.get(
		`/${userId}/streams/artists/${artistId}/stats/per-day`,
	);
}

export async function getUserStreamArtistStatsDates(
	userId: string,
	artistId: string,
) {
	return await axiosInstance.get(
		`/${userId}/streams/artists/${artistId}/stats/dates`,
	);
}
...
export async function getUserStreamAlbumStatsPerDay(
	userId: string,
	albumId: string,
) {
	return await axiosInstance.get(
		`/${userId}/streams/albums/${albumId}/stats/per-day`,
	);
}

export async function getUserStreamAlbumStatsDates(
	userId: string,
	albumId: string,
) {
	return await axiosInstance.get(
		`/${userId}/streams/albums/${albumId}/stats/dates`,
	);
}
...
export async function getSpotifyFeatures(
	...
	const res = await axios.get(
		`${url}/api/v1/spotify/audio-features/${trackId}`,
	);
